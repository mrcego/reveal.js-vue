...
import { ref, onMounted, onUnmounted, h, useSlots } from 'vue';
...
// Extracted NavigationControls component functionality
...
const Columns = {
    setup(props: any, { slots }: any) {
        return () => {
            ...
            // filter out comments/fragments if necessary. simplest is just map.
			...
			<Columns>
				<template #default>
					<div>
						...
						<Fragment animation="highlight-red" as="p">
				...
				<template #default>
					<div style="text-align: left;">
						...
						<div style="margin-top: 1em;">
                            <button :style="buttonStyle" @click="goPrev">
                                Previous
                            </button>
                            <button :style="buttonStyle" @click="goNext">
                                Next
                            </button>
                        </div>
					</div>
