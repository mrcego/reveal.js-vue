...
import { ref, watch, onMounted, onUnmounted, provide, shallowRef, useAttrs, computed } from 'vue';
...
const deckDivRef = ref<HTMLDivElement | null>(null);
const slidesDivRef = ref<HTMLDivElement | null>(null);
...
<template>
	<div :class="revealClasses" :style="(attrs.style as any)" ref="deckDivRef">
		<div class="slides" ref="slidesDivRef">
			<slot />
		</div>
	</div>
</template>
